    ...
    private void previewPdf() {
        ...
        if (pdfFile.exists()) {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "Please install MS-Excel app to view the file.",
                        Toast.LENGTH_SHORT).show();
            } catch (Exception e) {

                Toast.makeText(getApplicationContext(), "No view available to open this Excel file or Something went wrong",
